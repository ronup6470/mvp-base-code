...
// ---------------------------------------------------------- //
import { CUSTOMER_FILTER, CustomerFilterRecord } from '../../../customer.model';
...
export class CustomerFilterPresentationComponent {
  ...
  public filterData: Subject<CustomerFilterRecord>;
  ...
  constructor(
    ...
    @Optional() @Inject(CUSTOMER_FILTER) private data: CustomerFilterRecord,
  ) {
